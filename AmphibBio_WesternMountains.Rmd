...
RALU <- terra::project(RALU,"EPSG:32610")
...
system.time({
AMMA_montane_mod <- predict(Sprasts_montane, AMMA_rfm)
})
stopCluster(my.cluster)

writeRaster(AMMA_montane_mod,paste0(here("Outputs","Predictions"),"/AMMA_montane_RFmod.tif"), overwrite=TRUE)

## AMMA - Boreal
# Start AMMA - True Record
AMMA_1km$ID <- paste0("T",AMMA_pres$ID)
AMMA_1km_boreal <- crop(AMMA_1km, Boreal)
...
system.time({
AMMA_boreal_mod <- predict(Sprasts_boreal, AMMA_rfm)
})
stopCluster(my.cluster)

writeRaster(AMMA_boreal_mod,paste0(here("Outputs","Predictions"),"/AMMA_boreal_RFmod.tif"), overwrite=TRUE)

## ANBO
# Start ANBO - True Record
ANBO_1km$ID <- paste0("T",ANBO_pres$ID)
ANBO_1km_montane <- crop(ANBO_1km, Montane)
...
writeRaster(ANBO_montane_mod,paste0(here("Outputs","Predictions"),"/ANBO_montane_RFmod.tif"), overwrite=TRUE)

## ANBO - Boreal
# Start ANBO - True Record
ANBO_1km$ID <- paste0("T",ANBO_pres$ID)
ANBO_1km_boreal <- crop(ANBO_1km, Boreal)
...
system.time({
ANBO_boreal_mod <- predict(Sprasts_boreal, ANBO_rfm)
})
stopCluster(my.cluster)

writeRaster(ANBO_boreal_mod,paste0(here("Outputs","Predictions"),"/ANBO_boreal_RFmod.tif"), overwrite=TRUE)


## RALU
# Start RALU - True Record
RALU_1km$ID <- paste0("T",RALU_pres$ID)
RALU_1km_montane <- crop(RALU_1km, Montane)
...
system.time({
RALU_montane_mod <- predict(Sprasts_montane, RALU_rfm)
})
stopCluster(my.cluster)

writeRaster(RALU_montane_mod,paste0(here("Outputs","Predictions"),"/RALU_montane_RFmod.tif"), overwrite=TRUE)

## RALU - Boreal
# Start RALU - True Record
RALU_1km$ID <- paste0("T",RALU_pres$ID)
RALU_1km_boreal <- crop(RALU_1km, Boreal)
...
system.time({
RALU_boreal_mod <- predict(Sprasts_boreal, RALU_rfm)
})
stopCluster(my.cluster)

writeRaster(RALU_boreal_mod,paste0(here("Outputs","Predictions"),"/RALU_boreal_RFmod.tif"), overwrite=TRUE)

## RASY
# Start RASY - True Record
RASY_1km$ID <- paste0("T",RASY_pres$ID)
RASY_1km_montane <- crop(RASY_1km, Montane)
...
system.time({
RASY_montane_mod <- predict(Sprasts_montane, RASY_rfm)
})
stopCluster(my.cluster)

writeRaster(RASY_montane_mod,paste0(here("Outputs","Predictions"),"/RASY_montane_RFmod.tif"), overwrite=TRUE)

## RASY - Boreal
# Start RASY - True Record
RASY_1km$ID <- paste0("T",RASY_pres$ID)
RASY_1km_boreal <- crop(RASY_1km, Boreal)
...
system.time({
RASY_boreal_mod <- predict(Sprasts_boreal, RASY_rfm)
})
stopCluster(my.cluster)

writeRaster(RASY_boreal_mod,paste0(here("Outputs","Predictions"),"/RASY_boreal_RFmod.tif"), overwrite=TRUE)

## RASY - Taiga
# Start RASY - True Record
RASY_1km$ID <- paste0("T",RASY_pres$ID)
RASY_1km_taiga <- crop(RASY_1km, Taiga)
...
system.time({
RASY_taiga_mod <- predict(Sprasts_taiga, RASY_rfm)
})
stopCluster(my.cluster)

writeRaster(RASY_taiga_mod,paste0(here("Outputs","Predictions"),"/RASY_taiga_RFmod.tif"), overwrite=TRUE)

## AMTI - Montane
# Start AMTI - True Record
AMTI_1km$ID <- paste0("T",AMTI_pres$ID)
AMTI_1km_montane <- crop(AMTI_1km, Montane)
...
system.time({
AMTI_montane_mod <- predict(Sprasts_montane, AMTI_rfm)
})
stopCluster(my.cluster)

writeRaster(AMTI_montane_mod,paste0(here("Outputs","Predictions"),"/AMTI_montane_RFmod.tif"), overwrite=TRUE)
...
RASY_RFmod <- merge(RASY_boreal_RFmod,RASY_montane_RFmod)

RASY_taiga_RFmod <- rast(paste0(here("Outputs","Predictions"),
                                 "/RASY_taiga_RFmod.tif"))
RASY_RFmod <- merge(RASY_taiga_RFmod,RASY_taiga_RFmod)
