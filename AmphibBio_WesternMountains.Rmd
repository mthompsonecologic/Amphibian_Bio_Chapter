...
Loading a shapefile of Nak'azdli Whut'en territory to calculate statistics for this part of the study area.

```{r Nakazdli, echo=FALSE, eval=FALSE}


Nakazdli <- vect(paste0(here("Inputs","Shapefiles"), "/Nakazdli_Territory.shp"))

Nakazdli <- terra::project(Nakazdli,
                          "EPSG:4326")

ECOSEC <- vect(paste0(here("Inputs","Shapefiles","ERC_ECOSECTIONS_SP"), "/ERC_ECOSEC_polygon.shp"))
...
GLC_FCS30Dm <- merge(GLC_FCS30Dr)
GLC_FCS30Dc <- crop(GLC_FCS30Dm,Nakazdli,mask=TRUE)
